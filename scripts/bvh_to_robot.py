...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--robot",
        choices=["unitree_g1", "unitree_g1_with_hands", "booster_t1", "booster_t1_29dof", "booster_t1_29dof_inspire_custom", "stanford_toddy", "fourier_n1", "engineai_pm01", "pal_talos"],
        default="unitree_g1",
    )
